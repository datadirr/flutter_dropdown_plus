...
class DropdownTextField<T> extends StatefulWidget {
  ...
  /// The initial value to be selected for [DropdownTextField]. The value
  ...
  /// `validator` for the [DropdownTextField]
              ...
              itemBuilder:
                  (context, index) => InkWell(
                    ...
                    child: Container(
                      ...
                      alignment: Alignment.centerLeft,
                      decoration:
                          widget.suggestionItemDecoration?.copyWith(
                            border:
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        if (!widget.hasOverlay)
          SizedBox(height: widget.offset != null ? widget.offset!.dy : 0),
